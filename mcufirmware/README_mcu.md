...
## Trigger Mechanism
The backend sends a serial command: 99\n
...
3. The MCU streams all 25,600 grayscale pixel values in the format:  v1 v2 v3 v4 ... v25600
...
## Compatibility
This output format is required by:  backend/server.py
